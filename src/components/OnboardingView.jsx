...
import { ArrowRight, ArrowLeft, Sparkles, Loader, Search, Star, Users, LayoutTemplate, FilePlus, Briefcase, Home } from 'lucide-react';
        ...
        return (
          <div className="text-center">
            ...
            <div className="space-y-6 max-w-md mx-auto">
              ...
              {data.projectClass === 'treasury' && (
                  <div className="mt-6 text-left">
                      <label className="block text-sm font-medium text-gray-700 mb-2">Ce projet est pour un usage :</label>
                      <div className="flex justify-center gap-4 bg-gray-100 p-1 rounded-lg">
                          <button 
                              type="button"
                              onClick={() => setData(prev => ({ ...prev, projectType: 'business' }))}
                              className={`flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-colors flex items-center justify-center gap-2 ${data.projectType === 'business' ? 'bg-white shadow text-blue-600' : 'text-gray-600'}`}
                          >
                              <Briefcase size={16} /> Professionnel
                          </button>
                          <button 
                              type="button"
                              onClick={() => setData(prev => ({ ...prev, projectType: 'household' }))}
                              className={`flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-colors flex items-center justify-center gap-2 ${data.projectType === 'household' ? 'bg-white shadow text-green-600' : 'text-gray-600'}`}
                          >
                              <Home size={16} /> Ménage
                          </button>
                      </div>
